...
public final class MurderMystery implements ModInitializer {
	...
	static final TagKey<Block> MANSION_SPAWN_ON = TagKey.of(Registry.BLOCK_KEY, new Identifier(MOD_ID, "mansion_spawn_on"));
	static final TagKey<Block> METRO_SPAWN_ON = TagKey.of(Registry.BLOCK_KEY, new Identifier(MOD_ID, "metro_spawn_on"));
